                ...
                <div class="row g-4">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-4  ">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <span>moneersalmeen@gmail.com</span>
                                </div>
                            </div>
                            <div class="col-md-4  "
                    ...
                    <div class="col-md-6">
                        <div class=" Up" style="visibility: visible; animation-delay: 0.5s; animation-name: Up;">
                            <p class="mb-4">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt at voluptas
                                praesentium ipsum sunt neque, delectus non reprehenderit, mollitia, obcaecati officia
                                dolorem consequuntur tempore eos quam? Dignissimos fugiat voluptatibus ad.</p>
                            <form>
                                <div class="row g-3">
                                    <div class="col-md-6">
