...
<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center flex-column  justify-content-center px-2 py-3" href="index.html">
        <div class="sidebar-brand-icon mb-2">
            <img src="assets/img/myPhoto.jpg" alt="myphoto" class="img-fluid rounded-circle">
        </div>
        <div class="sidebar-brand-text mx-0">Moneer Al-kathiri </div>
    </a>
